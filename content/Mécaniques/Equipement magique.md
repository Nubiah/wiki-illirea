...
| ----------------------------- | -------------- | ------ | -------- | ------------- | -------------------------------------- |
| Arc Neglour                   | **Inhabituel** | 30 m   |          | Perforant     | Ajoute 1 succès à votre test d'attaque |
# Armures

| Désignation              | Qualité        | DEF | DEF Magique | Notes complémentaires                                                                                                                                                  |
| ------------------------ | -------------- | --- | ----------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Armure de Morulith       | **Rare**       | +3  | +3          | Immunité à la foudre                                                                                                                                                   |
| Armure de plaque d'épine | **Rare**       | +6  |             | Tout attaquant au corps à corps subit 3 points de dégâts                                                                                                               |
| Robe d'érudition         | **Inhabituel** | +1  | +3          | Permet une relance d'un dé lors d'un test de magie                                                                                                                     |
| Armure du Croc           | **Inhabituel** | +2  |             | Immunité au froid & à la chaleur                                                                                                                                       |
| Armure runique naine     | **Epique**     | +6  | +3          | Bouclier magique : protège de 10 points de dégâts magique (repos long pour recharger)                                                                                  |
| Robe de Reine Smaklins   | **Inhabituel** | +1  | +3          | Immunité au feu. +2 à la compétence **Survie**. En effet, la robe peut se manger. En cas de test de Survie lié à la nourriture, perd 1 de durabilité. 3 de durabilité. |
| Pin's Krakno             | **Inhabituel** | /   | /           | +1 à la compétence **Représentation**                                                                                                                                  |
| Bouclier Ohberen         | **Rare**       | /   | /           | Réduction de dégâts de 5                                                                                                                                               |
| Armure de Strodbenk      | **Rare**       | +3  | +3          | Immunité au feu. Réchauffe l'usager                                                                                                                                    |

# Accessoires

|Désignation|Qualité|Notes complémentaires|
|---|---|---|
|Amulette de Nostro|**Epique**|+1 succès à tous vos tests de compétence (hors attaque)|
|Cape de furtivité|**Inhabituel**|Permet une relance d'un dé lors d'un test de discrétion|
|Amulette de la nuit|**Rare**|Permet de générer un brouillard (sphère de 10 m de diamètre). Cooldown : 10 tours|
|Cape d'améthyste|**Maudit**|Ne peux plus être enlevée volontairement par le porteur. Vous vous sentez irrésistible !|